...
public class StinkCloud : MonoBehaviour
{
    ...
    public event Action OnCloudDestroyed;
    ...
    public void Initialize(float damage, float duration, float radius)
    {
        ...
        Invoke(nameof(DestroyCloud), duration);
    }

    private void DestroyCloud()
    {
        OnCloudDestroyed?.Invoke();
        Destroy(gameObject);
    }
    ...
    private void ApplyDamageAndEffects(GameObject targetObject)
    {
        ...
        if (target != null && enemy != null)
        {
            ...
            {
                visualEffect.ApplyEffect(AttackType.Stink);
            }
        }
    }
